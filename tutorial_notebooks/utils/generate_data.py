...
class PointCloud():
    ...
    def mobius(self):
        ...
        for _ in range(self.n_samples):
            ...
            # domain of parameters
            t = np.random.uniform(-0.5, 0.5, n_points)
            s = np.random.uniform(0.0, 2*np.pi, n_points)
    ...
    def klein_bottle(self):
        ...
        for _ in range(self.n_samples):
            ...
            # domain of parameters
            u = np.random.uniform(0.0, np.pi, n_points)
            v = np.random.uniform(0.0, 2*np.pi, n_points)
